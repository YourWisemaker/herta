...
statistics.distributions.normal = {
   ...
   */
  cdf: function(x, mean = 0, stdDev = 1) {
   ...
   */
  sample: function(mean = 0, stdDev = 1, n = 1) {
...
statistics.distributions.t = {
  ...
  pdf: function(x, dof) {
    ...
    return (numerator / denominator) * Math.pow(1 + (x*x)/dof, -(dof + 1) / 2);
  }
};
...
statistics.timeSeries = {
   ...
   */
  exponentialMovingAverage: function(data, alpha) {
   ...
   */
  autocorrelation: function(data, lag) {
